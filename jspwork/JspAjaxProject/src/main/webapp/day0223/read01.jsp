...
<body>
	...
	<br>
	<button type="button" class="btn btn-info" id="btn1">data1.xml열기</button>
	<button type="button" class="btn btn-danger" id="btn2">data1.json열기</button>
	<br>
