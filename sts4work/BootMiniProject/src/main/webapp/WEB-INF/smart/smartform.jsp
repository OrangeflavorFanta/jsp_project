...
<body>
   <form action="insert" method="post"> <!-- 여기문제.... -->
      <table class="table table-bordered" style="width: 800px; margin-left: 100px;">
         ...
         <tr>
            ...
            <td colspan="3">
               <input type="text" name="sangname" class="form-control" required="required" style="width: 500px;">
            </td>
         </tr>
         ...
         <tr>
            ...
            <td>
               <input type="text" name="price" class="form-control" required="required" style="width: 150px;">
            </td>
         </tr>
          ...
          <tr>
            ...
            <td colspan="3">
               <input type="date" name="ipgoday" class="form-control" required="required" style="width: 500px;">
            </td>
         </tr>
